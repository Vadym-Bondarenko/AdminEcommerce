...
export class CategoriesComponent implements OnInit {
  ...
  constructor(private categoriesService: CategoriesService, public dialog: MatDialog, private subcategoriesService: SubcategoriesService, private imagesService: ImageService ) { }
